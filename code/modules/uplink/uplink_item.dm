...
/datum/uplink_item/role_restricted/godhand
	name = "God's Wrath"
	desc = "Gain the favor of a particularly vengeful god by giving it 20 TC. This transaction will most likely make the god focus his strength and energy into your empty hand. You need to have an open hand during the transaction or else it will disappear!"
